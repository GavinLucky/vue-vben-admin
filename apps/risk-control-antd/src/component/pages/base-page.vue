...
const viewLoadingComputed = computed(() => {
  return viewLoading;
});
...
<template>
  <div class="relative">
    ...
    <div
      ...
      class="absolute bottom-0 left-0 right-0 top-0 box-border flex flex-row items-center justify-center"
    >
      <div>
        <ASpin :spinning="viewLoadingComputed" />
      </div>
    </div>
  </div>
</template>
